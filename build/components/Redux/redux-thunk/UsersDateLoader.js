...
export function UsersDateLoader() {
    return function (dispatch, getState) {
        return __awaiter(this, void 0, void 0, function () {
            var accessToken, refreshToken, response, newAccessToken, data, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch('http://localhost:5000/api/user/usersDate', {
                                method: 'GET',
                                headers: {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        console.error('Ошибка загрузки данных:', err_1);
                        return [3 /*break*/, 4];
...
//# sourceMappingURL=UsersDateLoader.js.map